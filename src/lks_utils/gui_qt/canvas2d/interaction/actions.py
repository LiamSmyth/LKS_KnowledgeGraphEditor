...
CANVAS_PRIMARY = Action(
    ...
    category="Canvas",
    description="Routed to the topmost object under the cursor.",
    scope="canvas2d",
)
...
CANVAS_SECONDARY = Action(
    ...
    category="Canvas",
    description="Routed to the topmost object under the cursor (context menu).",
    scope="canvas2d",
)

CANVAS_OBJECT_DRAG = Action(
    id="canvas2d.object.drag",
    label="Drag object",
    category="Canvas/Objects",
    scope="canvas2d",
)
