...
@register_canvas_object_type("canvas2d.anchored_widget_object")
class CanvasAnchoredWidgetObject(CanvasObjectWidgetAdapter):
    """Reparent a widget into the canvas host and position it per view."""

    OBJECT_TYPE: str = "canvas2d.anchored_widget_object"
    ...
    def _ensure_attached(self, ctx: CanvasPaintContext) -> None:
        ...
        # matching the opaque look produced by the CanvasPixmapWidgetObject path.
...
class _HostLifecycleFilter(QObject):
    ...
    def __init__(self, owner: CanvasAnchoredWidgetObject) -> None:
        super().__init__()
        self._owner = owner
...
__all__ = ["CanvasAnchoredWidgetObject"]
