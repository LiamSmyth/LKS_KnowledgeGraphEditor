"""Pixmap-backed CanvasObject adapter for canvas-blind Qt widgets."""
...
class _WidgetUpdateFilter(QObject):
    ...
    def __init__(self, owner: "CanvasPixmapWidgetObject") -> None:
...
@register_canvas_object_type("canvas2d.pixmap_widget_object")
class CanvasPixmapWidgetObject(CanvasObjectWidgetAdapter):
    """Render a wrapped widget into a cached pixmap and draw in world space."""

    OBJECT_TYPE: str = "canvas2d.pixmap_widget_object"
...
__all__ = ["CanvasPixmapWidgetObject"]
