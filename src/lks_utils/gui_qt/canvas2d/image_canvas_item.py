"""`ImageCanvasItem`: a canvas item that renders a file-backed raster image."""
...
@register_canvas_item_type("canvas2d.image_item")
class ImageCanvasItem(CanvasItem):
    ...
    ITEM_TYPE: str = "canvas2d.image_item"
    ...
    @classmethod
    def from_dict(cls, d: dict) -> ImageCanvasItem:
        r = d["world_rect"]
...
__all__ = ["ImageCanvasItem", "IMAGE_EXTENSIONS"]
