...
@register_canvas_object_type("knowledge.annotation_rect")
class KBRectAnnotationCanvasObject(CanvasObject):
    ...
    @classmethod
    def from_dict(cls, payload: dict[str, Any]) -> KBRectAnnotationCanvasObject:
...
__all__ = ["KBRectAnnotationCanvasObject"]
