"""Canvas item representing a positioned knowledge-base node reference."""
...
@register_canvas_item_type("knowledge.kb_node")
class KBNodeCanvasItem(CanvasItem):
    ...
    def to_dict(self) -> dict[str, Any]:
        """Serialize this node item to the canvas items-list shape."""
    ...
    @classmethod
    def from_dict(cls, payload: dict[str, Any]) -> KBNodeCanvasItem:
        """Deserialize a ``KBNodeCanvasItem`` from a plain mapping."""
