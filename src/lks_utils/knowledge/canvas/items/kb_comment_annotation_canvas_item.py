...
@register_canvas_item_type("knowledge.annotation_comment")
class KBCommentAnnotationCanvasItem(CanvasItem):
    ...
    @classmethod
    def from_dict(cls, payload: dict[str, Any]) -> KBCommentAnnotationCanvasItem:
...
__all__ = ["KBCommentAnnotationCanvasItem"]
