...
def knowledge_field_node_height_for_rows(rows: list[FieldRow]) -> float:
    ...
    content_height = (
        QKnowledgeFieldNodeCanvasItem._PADDING_WORLD * 2.0
        + QKnowledgeFieldNodeCanvasItem._HEADER_HEIGHT_WORLD
        + 4.0
        + visible_count * QKnowledgeFieldNodeCanvasItem._ROW_HEIGHT_WORLD
    )
    return min(
        QKnowledgeFieldNodeCanvasItem._MAX_CARD_HEIGHT_WORLD,
...
class _KnowledgeFieldNodeCanvasItemSignals(QObject):
    """Signal bridge for non-QObject canvas items."""
...
class QKnowledgeFieldNodeCanvasItem(CanvasPixmapWidgetItem):
    ...
    def __init__(
        ...
        *,
        ...
        on_select: Callable[[
            "QKnowledgeFieldNodeCanvasItem"], None] | None = None,
        ...
        self.signals = _KnowledgeFieldNodeCanvasItemSignals()
...
__all__ = ["QKnowledgeFieldNodeCanvasItem",
